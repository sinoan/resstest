...
AddRandomOptionExtension( "TYPE1_PET", "TYPE2_PET_PICKUP" )
--{
	SetRandomOptionMaterial( "TYPE1_AWAKE", "TYPE2_AWAKE_PET_PICKUP" )
...
AddRandomOptionExtension( "TYPE1_PET", "TYPE2_PET_BUFF" )
--{
	SetRandomOptionMaterial( "TYPE1_AWAKE", "TYPE2_AWAKE_PET_PICKUP" )
