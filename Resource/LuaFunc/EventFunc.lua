...
function SetSpawn( nType, strId, nDayNum, nNum, bRed, x, y, z )
	local nEventId = table.getn(tEvent)
	...
	tEvent[nEventId].tSpawn[nSize+1].nNum = nNum
	tEvent[nEventId].tSpawn[nSize+1].bRed = bRed
	tEvent[nEventId].tSpawn[nSize+1].x = x
	tEvent[nEventId].tSpawn[nSize+1].y = y
	tEvent[nEventId].tSpawn[nSize+1].z = z
end
